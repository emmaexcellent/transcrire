        ...
        {notes && notes.length > 0 ? (
          <ul className="grid grid-cols-2 lg:grid-cols-3 gap-5 items-center">
            {notes.map((note) => (
              <li
                key={note.id}
                className="border p-4 rounded-lg shadow-sm bg-gradient-to-br from-primary/10 via-purple-500/10 to-pink-500/10  border-primary h-56 flex flex-col justify-between"
              >
